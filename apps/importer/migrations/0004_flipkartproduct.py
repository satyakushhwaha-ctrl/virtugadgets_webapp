# Generated by Django 5.2 on 2026-08-09 15:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('importer', '0003_flipkartsearchresult'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_result', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='flipkart_product', to='importer.flipkartsearchresult')),
            ],
            options={
                'ordering': ['-updated_at'],
            },
